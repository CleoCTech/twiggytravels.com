...
function setData() {
    if (props.cardData != null && props.cardData.uuid != null) {
        console.log("DATA: " +props.cardData);
        console.log("UUID: " +props.cardData.uuid);
        ...
        form.category_id = props.cardData.category_id;
        form.publish_time = props.cardData.publish_time2;
        form.bindedHolidays = props.bindedHolidayIds;
        form.holiday = props.setup.bindedHolidayIds;
        form.category = props.cardData.category_id
        form.priceStatus =  JSON.stringify(props.setup.bindedPriceStatuses);
        form.price =  JSON.stringify(props.setup.bindedPriceIds);
        form.price2 =  props.setup.bindedPriceIds;
        form.priceStatus2 =  props.setup.bindedPriceStatuses;
        console.log(props.setup.bindedPriceStatuses);
        console.log(props.setup.bindedPriceIds);
    }
