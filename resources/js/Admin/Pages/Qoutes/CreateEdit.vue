                ...
                <x-grid>
                    <x-grid-col>
                        <x-form-group>
                            ...
                            <template #value><x-input type="text" v-model="form.author"/></template>
                        </x-form-group>
                    </x-grid-col>
                    <x-grid-col>
                        <x-form-group>
                            <template #label>Qoute</template>
                            <template #value><x-input type="text" v-model="form.quote"/></template>
                        </x-form-group>
                    </x-grid-col>
                    <x-grid-col>
                        <x-form-group>
...
<script setup>
    ...
    function setData(){
        if (props.cardData != null && props.cardData.uuid != null) {
            ...
            form.author = props.cardData.author;
