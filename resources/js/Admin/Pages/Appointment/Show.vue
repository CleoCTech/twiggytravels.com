            ...
            <x-grid>
                ...
                <x-grid-col>
                    <x-show-group>
                        ...
                        <template #value>{{cardData.date}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                        <template #label>Service</template>
                        <template #value>{{cardData.service.title}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                        <template #label>From Time</template>
                        <template #value>{{cardData.timeslot.from_time}}</template>
                    </x-show-group>
                </x-grid-col>
                <x-grid-col>
                    <x-show-group>
                        <template #label>To Time</template>
                        <template #value>{{cardData.timeslot.to_time}}</template>
                    </x-show-group>
                </x-grid-col>
