                ...
                <x-grid>
                    ...
                    <x-grid-col>
                        <x-form-group>
                            ...
                            <template #value><x-input type="time" v-model="form.from_time"/></template>
                        </x-form-group>
                    </x-grid-col>
                    <x-grid-col>
                        <x-form-group>
                            <template #label>To Time </template>
                            <template #value><x-input type="time" v-model="form.to_time"/></template>
                        </x-form-group>
                    </x-grid-col>
...
<script setup>
    ...
    function setData(){
        if (props.cardData != null && props.cardData.uuid != null) {
            ...
            form.from_time = props.cardData.from_time;
            form.to_time = props.cardData.to_time;
