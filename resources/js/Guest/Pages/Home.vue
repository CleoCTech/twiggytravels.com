...
<template>
  ...
  <div v-else>
    ...
    <section class="home">
        <video src="../../../assets/video2.mp4" class="video-slide active" autoplay muted loop></video>
    ...
    <main class="main pt-0 ">
        ...
        <section class="curved-radius-top bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 -mt-44 mb-0">
            ...
            <h1 class="text-5xl font-bold text-center">Twiggy travels. "It's our time. Let's explore."</h1>
            <p class="pt-2 py-40" v-html="companyInfo.about"></p>
                ...
                <div class="py-16 bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">  
                    <div class="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
                        ...
                        <div class="md:5/12 lg:w-5/12">
                            <img class="rounded-img" src="/assets/images/rocks-down_1658560092.jpeg" alt="image" loading="lazy" width="" height="">
                        </div>
                        <div class="md:7/12 lg:w-6/12">
                            <h2 class="text-2xl text-gray-900 font-bold md:text-4xl">Twiggy travels is a tour and travel company based in Kenya.</h2>
                            <p class="text-gray-600 mt-1">The company offers unsurpassed and affordable tour services for groups, individuals, couples and corporates. Our general aim is to ensure that the clients get the best services and that their varied needs are equitably met. 
                            ...
                            The staff members are highly qualified with adequate skills necessary to steer and satisfy the needs of our clients. </p>                            <p class="mt-4 text-gray-600"> Nobis minus voluptatibus pariatur dignissimos libero quaerat iure expedita at? Asperiores nemo possimus nesciunt dicta veniam aspernatur quam mollitia.</p>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div v-for="(pakage,index) in packages" :key="index" >
                    <article class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-80 max-w-sm mx-auto mt-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,0.2)]">
                        ...
                        <div class="z-20 pt-2">
                            <Link :href="'/package/'+pakage.slug" data-te-ripple-init data-te-ripple-color="light" class=" inline-block rounded bg-cblack px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-[#b56952] hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-[#b56952] focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-[#b56952] active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">Learn more</Link>
                        </div>
                    </article>
                </div>
                ...
                <div v-for="(localDestination,index) in localDestinations" :key="index">
                    <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(141,99,76,0.07),0_10px_20px_-2px_rgba(141,99,76,0.04)] dark:bg-tbrown">
                        ...
                        <div class="p-6">
                            ...
                            <Link :href="'/local-destination/'+localDestination.slug" data-te-ripple-init data-te-ripple-color="light" class="inline-block rounded bg-cblack px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-[#b56952] hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-[#b56952] focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-[#b56952] active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">Learn more</Link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- PopularInternatinal destinations -->
        <section class="curved-radius-top pt-3 bg-cblack -mt-10"></section>
        <div class="curved-radius-top bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 -mt-44 px-4 py-16 mx-auto sm:px-6 lg:px-8">
            <h4 class="text-4xl font-bold text-gray-800 tracking-widest uppercase text-center">Popular Inernational destinations</h4>
            <p class="text-center text-gray-600 text-sm mt-2 mb-6">Here are some of the frequently asked questions</p>
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div v-for="(internalDestination,index) in internalDestinations" :key="index">
                    <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(141,99,76,0.07),0_10px_20px_-2px_rgba(141,99,76,0.04)] dark:bg-tbrown">
                        <div class="relative overflow-hidden bg-cover bg-no-repeat" data-te-ripple-init data-te-ripple-color="light">
                            <img :src="'/storage/destinations/cover_images/'+internalDestination.cover_image" class="w-full rounded-t-lg" />
                            <a href="#!">
                                <div class="absolute top-0 right-0 bottom-0 left-0 h-full w-full bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100 bg-[hsla(0,0%,98.4%,0.2)]"></div>
                            </a>
                            <svg class="absolute left-0 bottom-0 text-white dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        ...
                        <div class="p-6">
                            <h5 class="mb-4 text-lg font-bold text-white">Tour</h5>
                            <p class="mb-6 text-gray-300">
                                {{ internalDestination.title }}
                            </p>
                            <Link :href="'/international-destination/'+internalDestination.slug" data-te-ripple-init data-te-ripple-color="light" class="inline-block rounded bg-cblack px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-[#b56952] hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-[#b56952] focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-[#b56952] active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">Learn more</Link>
                        </div>
                    </div>
                </div>
            </div>
