      ...
      <section class="banner bg-gray-700"
        ...
        <div class="container mx-auto flex items-center justify-start h-full py-20">
          <div class="text-white">
            <h5 class="text-base mb-2">Home > Tours</h5>
              ...
              <div class="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
                ...
                <div class="md:7/12 lg:w-6/12">
                  <div class="w-full  px-3 mb-6">
                    <div class="md:6/12 lg:w-5/12">
                        <img class="rounded-img" :src="'/storage/destinations/cover_images/' + cardData.cover_image " alt="image" loading="lazy" width="" height="">
                    </div>
                    <div class="mb-4">
                      ...
                      <div class="flex justify-between items-center">
                        ...
                        <p class="text-sm">Tour Type: {{ cardData.destination_category.name }}</p>
                      </div>
                    </div>
                    <hr />
                    <div class="mb-4">
