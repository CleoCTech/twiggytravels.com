...
class PriceCategoryBinding extends Model
{
    use HasFactory;
    use UuidTrait;
    use SearchTrait;
    ...
    /**
     * Get the destination that owns the PriceCategoryBinding
     *
    ...
    /**
     * Get the priceCategory that owns the PriceCategoryBinding
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
