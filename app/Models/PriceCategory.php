...
class PriceCategory extends Model
{
    ...
    /**
     * Get all of the priceBindings for the PriceCategory
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function priceBindings(): HasMany
    {
        return $this->hasMany(PriceCategoryBinding::class, 'price_category_id', 'id');
    }
}