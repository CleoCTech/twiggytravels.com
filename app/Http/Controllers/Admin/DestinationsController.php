...
class DestinationsController extends Controller
{
    ...
    public $settings = [
        ...
        'caption' =>  "Destination",
        'xFolder' =>  "Admin/Pages/Destinations",
        'indexRoute' =>  "/admin/destination",
    ...
    public function store(REQUEST $request){
        ...
        try{
            ...
            $destination = $this->defaultModel::updateOrCreate(["uuid" => $this->pKey], $record);
            ...
            if ($holidays != null) {
                if (DestinationHolidayBinding::where('destination_id', $destination->id)->exists()) {
                    DestinationHolidayBinding::where('destination_id', $destination->id)->delete();
                }
                foreach ($holidays as $holidayId) {
                    // Log::info("Id: " .$holidayId);
                    DestinationHolidayBinding::create([
            ...
            if ($priceBindings != null) {
                if (PriceCategoryBinding::where('destination_id', $destination->id)->exists()) {
                    PriceCategoryBinding::where('destination_id', $destination->id)->delete();
                }
            ...
            if ($bindedPriceStatuses != null) {
                foreach ($bindedPriceStatuses as $key => $value) {
                    if($value != null){
                        PriceCategoryBinding::where(function($query) use ($destination, $key) {
